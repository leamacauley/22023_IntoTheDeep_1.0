...
@Autonomous(name="Shaine's One Spec", group="Auto")

public class OneSpecAutoShaineMBR extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        driveStraightInches(-0.5, 6, 200);
        robot.waitForTick(200);
        pointTurnDegrees(0.5, 180, 200); // turns 90 degrees
        robot.waitForTick(200);
        driveStraightInches(0.5, 9, 200);
        robot.waitForTick(200);
        pointTurnDegrees(0.5, 180, 200);
